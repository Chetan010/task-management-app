...
import { MdAddTask, MdOutlineListAlt, MdOutlineTaskAlt} from "react-icons/md";
import { Link } from "react-router-dom";

const Sidebar = () => {
    return (
        <div className="bg-primary-color min-h-[100vh] sm:min-h-screen w-[5rem] sm:w-[19rem] flex flex-col gap-4 roboto-regular">
            ...
            <nav className="flex gap-10 justify-start">
                <ul className="py-6 flex flex-col justify-start">
                    ...
                    <Link to='/all-task' className="px-6 py-4 font-semibold text-lg text-gray-300 hover:text-gray-700 cursor-pointer flex justify-start items-center gap-2">
